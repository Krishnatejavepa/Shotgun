...
- For detailed security review guidance, see `.shotgun/references/security-checklist.md`
- For performance review checks, see `.shotgun/references/performance-checklist.md`
